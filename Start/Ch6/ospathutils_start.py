...
print("Items exits:", path.exists("textfile.txt"))
print("Items is a file:", path.isfile("textfile.txt"))
print("Items is a directory:", path.isdir("textfile.txt"))
...
print(f"It has been {td} since the file has been motified")
